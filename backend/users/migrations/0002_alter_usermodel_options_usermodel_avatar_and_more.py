# Generated by Django 4.2.17 on 2025-02-12 14:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='avatar',
            field=models.ImageField(blank=True, null=True, upload_to='users/image', verbose_name='Аватар профиля'),
        ),
        migrations.AlterField(
            model_name='usermodel',
            name='email',
            field=models.EmailField(max_length=254, unique=True, validators=[users.validators.validate_lowercase_email], verbose_name='Адрес электронной почты'),
        ),
        migrations.AlterField(
            model_name='usermodel',
            name='first_name',
